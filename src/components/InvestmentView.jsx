  ...
  return (
    <div className="page-transition-enter">
      ...
      <div className="glass-card card-animate" style={{ marginBottom: '18px', textAlign: 'center', padding: '24px 16px' }}>
        <div style={{ fontSize: '0.88rem', opacity: 0.85, marginBottom: '5px', display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '4px' }}>
        ...
        <div style={{ fontSize: '2.2rem', fontWeight: '800', letterSpacing: '-0.02em' }}>{formatMoney(totalMarketValue)}</div>
        <div style={{ display: 'flex', justifyContent: 'space-around', marginTop: '15px', borderTop: '1px solid var(--glass-border)', paddingTop: '12px', flexWrap: 'wrap', gap: '10px' }}>
          ...
          <div className="nobrk" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><div style={{ fontSize: '0.73rem', opacity: 0.8 }}>未實現損益(台幣)</div><div style={{ fontWeight: '700', fontSize: '1rem', color: totalUnrealizedProfit >= 0 ? 'var(--accent-green)' : 'var(--accent-red)' }}>{totalUnrealizedProfit >= 0 ? '+' : ''}{formatMoney(totalUnrealizedProfit)}</div></div>
        </div>
      </div>
