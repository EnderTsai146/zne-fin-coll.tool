...
const WIZARD_CATEGORIES = [
  ...
  },
  {
    ...
    scenarios: [
      ...
      {
        id: 'cc_variable_bill_pay',
        title: '水電瓦斯等「變動金額帳單」，如何在到期認列時輸入當期實際發票金額？',
        route: '選單【記帳】 ➔ 子頁籤【📅 帳單】 ➔ 點擊【📊 變動金額帳單】 ➔ 輸入當期實際金額',
        targetPage: 'expense',
        targetTab: 'bills',
        targetHint: '已帶您前往【帳單中心】！點擊變動帳單即可輸入當期實際數字並認列。',
        steps: [
          '進入「✍️ 記帳 ➔ 📅 帳單」分頁。',
          '在列表中找到帶有「📊 變動金額」標籤的帳單（如水電費、瓦斯費、手機電信費）並點擊。',
          '在彈出視窗的「請輸入本期實際帳單金額」大輸入框中，直接填入本期收到的真實發票/扣款金額。',
          '選擇扣款帳戶與入帳日期後點擊「確定繳納」，系統會以該實際金額精準扣款與認列費用，並自動將帳單推算至下一期！'
        ]
      },
      {
